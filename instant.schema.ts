...
const _schema = i.schema({
  entities: {
    ...
    "$users": i.entity({
      ...
      "subscription_start_date": i.number().optional(),
      "subscription_canceled_at": i.number().optional(),
      "acq_source": i.string().optional(),
      "acq_source_set_at": i.number().optional(),
      "trial_expiring_email_sent": i.boolean().optional(),
      "trial_expired_email_sent": i.boolean().optional(),
    }),
    ...
    "guests": i.entity({
      ...
      "needs_accommodation": i.boolean().optional(),
